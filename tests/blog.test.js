...
test('favorite blog', () => {
  ...
  const sevenblogs = [
    ...
    { title: "TDD harms architecture", author: "Robert C. Martin", url: "http://blog.cleancoder.com/uncle-bob/2017/03/03/TDD-Harms-Architecture.html", likes: 1500 }, 
    { title: "Type wars", author: "Robert C. Martin", url: "http://blog.cleancoder.com/uncle-bob/2016/05/01/TypeWars.html", likes: 2 },
    { title: "A New Hope", author: "Robert C. Martin", url: "https://blog.cleancoder.com/uncle-bob/2020/04/05/ANewHope.html", likes: 7 }
]

    const toEq = { title: "TDD harms architecture", author: "Robert C. Martin", url: "http://blog.cleancoder.com/uncle-bob/2017/03/03/TDD-Harms-Architecture.html", likes: 1500 }
  
    const result = listHelper.favoriteBlog(sevenblogs)
